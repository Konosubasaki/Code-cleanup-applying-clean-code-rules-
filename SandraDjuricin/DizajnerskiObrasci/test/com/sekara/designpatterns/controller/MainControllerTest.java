...
class MainControllerTest {
	...
	void testEditShapePoint() {
		...
		assertEquals("CMD_UPDATE_POINT_EXECUTE#Point(X:1|Y:1|EdgeColor:-16777216)->Point(X:1|Y:1|EdgeColor:-16777216)",mainController.getExecutedCommands().pop().getLog());
	}
	@Test
	void testEditShapeLine() {
		...
		mainController.editShape();
		assertEquals("CMD_UPDATE_LINE_EXECUTE#Line(X1:1|Y1:1|X2:1|Y2:10|EdgeColor:-16777216)->Line(X1:1|Y1:1|X2:1|Y2:10|EdgeColor:-16777216)",mainController.getExecutedCommands().pop().getLog());
	...
	void testEditShapeRectangle() {
		...
		mainController.editShape();
		assertEquals("CMD_UPDATE_RECTANGLE_EXECUTE#Rectangle(X:1|Y:1|W:10|H:5|EdgeColor:-16777216|InnerColor:-1)->Rectangle(X:1|Y:1|W:10|H:5|EdgeColor:-16777216|InnerColor:-1)",mainController.getExecutedCommands().pop().getLog());
	...
	void testEditShapeDonut() {
		...
		mainController.editShape();
		assertEquals("CMD_UPDATE_DONUT_EXECUTE#Donut(X:1|Y:1|R1:20|R2:10|EdgeColor:-16777216|InnerColor:-1)->Donut(X:1|Y:1|R1:20|R2:10|EdgeColor:-16777216|InnerColor:-1)",mainController.getExecutedCommands().pop().getLog());
	...
	void testEditShapeCircle() {
		...
		mainController.editShape();
		assertEquals("CMD_UPDATE_CIRCLE_EXECUTE#Circle(X:1|Y:1|R:20|EdgeColor:-16777216|InnerColor:-1)->Circle(X:1|Y:1|R:20|EdgeColor:-16777216|InnerColor:-1)",mainController.getExecutedCommands().pop().getLog());
	...
	void testEditShapeHexagonShape() {
		...
		mainController.editShape();
		assertEquals("CMD_UPDATE_HEXAGON_EXECUTE#Hexagon(X:1|Y:1|R:20|EdgeColor:-16777216|InnerColor:-1)->Hexagon(X:1|Y:1|R:20|EdgeColor:-16777216|InnerColor:-1)",mainController.getExecutedCommands().pop().getLog());
	...
	void testDeleteSelectedShapes() {
		...
		assertEquals("CMD_DELETE_EXECUTE#[Point(X:1|Y:1|EdgeColor:-16777216)]",mainController.getExecutedCommands().pop().getLog());
	...
	void testDeleteAllShapes() {
		...
		assertEquals("CMD_DELETE_EXECUTE#[Point(X:1|Y:1|EdgeColor:-16777216), Hexagon(X:1|Y:1|R:20|EdgeColor:-16777216|InnerColor:-1)]",mainController.getExecutedCommands().pop().getLog());
	}
	...
	void testPositionToFront() {
		...
		assertEquals("CMD_TO_FRONT_EXECUTE#Point(X:1|Y:1|EdgeColor:-16777216)",mainController.getExecutedCommands().pop().getLog());
	}
	...
	void testPositionToBack() {
		...
		assertEquals("CMD_TO_BACK_EXECUTE#Point(X:1|Y:1|EdgeColor:-16777216)",mainController.getExecutedCommands().pop().getLog());
	}
	...
	void testPositionBringToFront() {
		...
		assertEquals("CMD_BRING_TO_FRONT_EXECUTE#Point(X:1|Y:1|EdgeColor:-16777216)",mainController.getExecutedCommands().pop().getLog());
	}
	...
	void testPositionBringToBack() {
		...
		assertEquals("CMD_BRING_TO_BACK_EXECUTE#Point(X:1|Y:1|EdgeColor:-16777216)",mainController.getExecutedCommands().pop().getLog());
	}
	...
	void testUndoCommand() {
		...
		assertEquals("CMD_ADD_UNEXECUTE#Point(X:1|Y:1|EdgeColor:-16777216)",mainController.getUnexecutedCommands().pop().getLog());
	...
	void testRedoCommand() {
		...
		assertEquals("CMD_ADD_EXECUTE#Point(X:1|Y:1|EdgeColor:-16777216)",mainController.getExecutedCommands().pop().getLog());
